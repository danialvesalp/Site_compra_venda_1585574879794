...
// Import Models
import { Produto } from '../../domain/site_compra_venda_db/produto';
...
*
* CategoriaService.findBy_produtos
...
export class ProdutoEditComponent implements OnInit {
    ...
    externalCategoria__produtos: Categoria[];
    model: Produto;
    formValid: Boolean;
    ...
    private location: Location) {
        ...
        this.externalCategoria__produtos = [];
    }
    ...
    ngOnInit() {
        this.route.params.subscribe(param => {
            ...
            if (id !== 'new') {
                ...
                this.categoriaService.findBy_produtos(id).subscribe(list => this.externalCategoria__produtos = list);
            }
            // Get relations
        });
    }
